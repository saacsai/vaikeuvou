...
export async function getSession() {
  ...
  return session as { id: string; token: string; user_id: string; users: { id: string; phone: string; name: string | null; email: string | null; avatar_url: string | null; bio: string | null; vibe: string | null; instagram: string | null } }
}
